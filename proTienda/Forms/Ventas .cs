...
namespace proTienda
{
    public partial class frmVentas : Form
    {
        ...
        {
            InitializeComponent();
            double prmCANTIDAD = 0;
            double prmPRECIO = 0;
            string prmUSER_LOGIN = null;
            int prmID_CAJA = 0;
            string prmID_PRODUCTO = null;
            Temp_Ventas(prmUSER_LOGIN, prmID_CAJA, prmID_PRODUCTO, prmCANTIDAD, prmPRECIO);
            string prmUSER_NAME = null;
            ReadData(prmUSER_NAME,prmID_CAJA);
